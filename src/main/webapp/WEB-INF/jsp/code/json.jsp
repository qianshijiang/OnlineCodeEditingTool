...
<%
request.setAttribute("panel_number", "panel_2");
request.setAttribute("panel_li_number", "panel_2_1");
%>
...
<script type="text/javascript" src="../static/js/codemirror/addon/lint/json-lint.js"></script>
</head>
<body>
...
<div class="codeeditor_button">
    <button type="button" class="button button-primary" onclick="format_code();">校验</button>
 ...
 <section class="editormessage_info" id="editormessage">
  <pre class="codeerror" id="result"></pre>
</section>
<script type="text/javascript" src="../static/js/jscode/code/jsoncode.js"></script>
</body>
