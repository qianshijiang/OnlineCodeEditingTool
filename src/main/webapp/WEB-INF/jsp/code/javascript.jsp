...
request.setAttribute("panel_li_number", "panel_1_4");
%>
...
<!-- 引用主题 -->
<link media="screen" rel="stylesheet" href="../static/css/codemirror/theme/xq-light.css"/>
...
<script type="text/javascript" src="../static/js/codemirror/addon/comment/continuecomment.js"></script>
<script type="text/javascript" src="../static/js/codemirror/addon/comment/comment.js"></script>
<script type="text/javascript" src="../static/js/codemirror/mode/javascript/javascript.js"></script>
<script type="text/javascript" src="../static/js/codemirror/addon/lint/javascript-lint.js"></script>
</head>
<body>
...
<script type="text/javascript" src="../static/js/jscode/code/javascriptcode.js"></script>
</body>