...
request.setAttribute("panel_li_number", "panel_1_2");
%>
...
<script type="text/javascript" src="../static/js/codemirror/addon/selection/selection-pointer.js"></script>
...
<script type="text/javascript" src="../static/js/codemirror/mode/vbscript/vbscript.js"></script>
</head>
<body>
...
<script type="text/javascript" src="../static/js/jscode/code/html5code.js"></script>
</body>
